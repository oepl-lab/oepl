        ...
        <section id="research" className="section-y bg-gray-50">
          <div className="max-w-7xl mx-auto px-6">
            <div className="mb-12">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-[#080d1e]">{t.about.researchTitle}</h2>
            </div>
        ...
        <section id="patents" className="section-y bg-white">
          <div className="max-w-7xl mx-auto px-6">
            <div className="mb-12">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-[#080d1e]">{t.about.patentTitle}</h2>
            </div>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-2 mb-2">
                        ...
                        <span className="text-2xs text-[#9ca3af] font-mono">{patent.number}</span>
                        <span className="text-2xs text-[#9ca3af]">{formatPatentDate(patent.date)}</span>
                      </div>
